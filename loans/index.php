                ...
                <?php if($result->num_rows > 0): ?>
                    ...
                    ?>
                        <tr style="animation-delay: <?php echo $delay; ?>s">
                            <td>
                                <strong style="color: #7DB0FF;">#<?php echo $row['loan_id']; ?></strong>
                            </td>
                            <td>
                                <span style="font-weight: 600; color: #7DB0FF;">
                            ...
                            <td>
                                <div style="display: flex; flex-direction: column; gap: 2px;">
                                    ...
                                    <span style="font-size: 11px; color: #8AA0C8;">
                                        <i class="fas fa-id-card" style="color: #4F8CFF;"></i> 
