...
export default function CollectPaymentForm({ open, installment, busy, error, collector, onSubmit, onClose }) {
  ...
  const handlePayFull = () => setAmount(remaining.toFixed(2));
  const handlePayHalf = () => setAmount((remaining / 2).toFixed(2));
  const handleClearAmount = () => setAmount('0');

  const avatarGradient = `linear-gradient(135deg, #6366f1, #8b5cf6)`;
      ...
      <div className="inst-modal inst-modal-fintech inst-modal-collect">
        <header className="inst-modal-head inst-modal-head-fintech is-collect">
          <div className="inst-modal-head-left">
            <div className="inst-modal-icon primary" aria-hidden>
              <CashIcon />
            </div>
        ...
        <form onSubmit={handleSubmit} className="inst-modal-body">
            ...
            <div className="inst-context-row inst-context-row-multi">
              ...
              <div className="inst-context-item">
                ...
                <div>
                  ...
                  <span className="inst-context-value">#{installment.installmentNo}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="inst-form-section">
            ...
            <div className="inst-collector-card">
              <div className="inst-collector-avatar" style={{ background: avatarGradient }} aria-hidden>
                {initials(collectorName)}
              </div>
          ...
          <div className="inst-modal-actions">
            ...
            <button
              type="submit"
              className="inst-btn-confirm inst-btn-confirm-lg"
              disabled={busy || overLimit || enteredAmount <= 0}
            >
              <CheckIcon />
              {busy
                ? 'Saving…'
