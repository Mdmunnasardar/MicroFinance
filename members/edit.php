...
<head>
    ...
    <title>Edit Member - MicroFinance</title>
                ...
                <div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="address" rows="2" 
                                  class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200"><?php echo htmlspecialchars($data['address']); ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center pt-6">
                            <input type="checkbox" name="is_active" 
                                   <?php if($data['is_active']) echo "checked"; ?>
